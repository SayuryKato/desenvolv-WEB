...
<body>
    ...
    <div id="content">
        <h1>Cardápio da Semana - Café da Manhã</h1>
        ...
        foreach ($diasSemana as $dia) {
            ...
            $sql = "SELECT conteudoCardapio FROM Cardapio WHERE idRefeicao = 1 AND idDiaSemana = (SELECT idDiaSemana FROM DiaSemana WHERE nomeDiaSemana = '$dia')";
